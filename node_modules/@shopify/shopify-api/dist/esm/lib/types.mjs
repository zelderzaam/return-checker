...
const RELEASE_CANDIDATE_API_VERSION = ApiVersion.October25;
...
export { ApiVersion, BillingInterval, BillingReplacementBehavior, ClientType, LATEST_API_VERSION, LIBRARY_NAME, LogSeverity, RELEASE_CANDIDATE_API_VERSION, ShopifyHeader, privacyTopics };
